...
static var input: PipeData = load("res://data/pipes/input.tres")
static var output: PipeData = load("res://data/pipes/output.tres")
static var pipes: Array[PipeData] = [
	load("res://data/pipes/i_pipe.tres"),
	load("res://data/pipes/t_pipe.tres"),
	load("res://data/pipes/l_pipe.tres"),
	load("res://data/pipes/cross_pipe.tres"),
	load("res://data/pipes/anti_pipe.tres"),
]
